...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { college_id: @major.college_id, name: @major.name } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { college_id: @major.college_id, name: @major.name } }
