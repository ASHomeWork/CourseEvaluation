...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { course_id: @mark.course_id, score: @mark.score, user_id: @mark.user_id } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { course_id: @mark.course_id, score: @mark.score, user_id: @mark.user_id } }
